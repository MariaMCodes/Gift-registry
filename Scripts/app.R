...
#     p(strong("Brands"), align = "center", style = "color:white;background-color:#487AA1;border-radius:1px"),
    ...
    fluidRow(
      ...
      column(width = 6, p(strong("Description:"), "iPad Pro 2021 (EXPECTED RELEASE DATE Q1, 2021)", br(), strong("Colour:"), "Space Gray", br(), strong("Size:"), "11-inch (128 GB)", br(), strong("Price:"), "~$1,329 (Based on 2020 model)", br(), 
                          ...
                          target = "blank", br(), br(), em("Can use the trade-in value from my 2017 iPad Pro ($395 as of February 27, 2021)"), style = "color:black"), style = "background-color:#f0e1d2;padding:13px;border-radius:2px", align = "left")),
    br(),
    fluidRow(
      column(width = 1),
    ...
    fluidRow(
      column(width = 1),
      column(width = 4, img(src = "Chanel_necklace.jpg", height="110", width="130"), align = "center", style = "background-color:white;padding:18px;border-radius:2px"), 
  ...
  fluidRow(
  column(width = 1),
  column(width = 4, img(src = "Chanel_earrings.jpg", height="100", width="120"), align = "center", style = "background-color:white;padding:18px;border-radius:2px"), 
...
install.packages("rsconnect")  
library(rsconnect)
# - once you've logged into your shinyapps.io account, 
# - click on dashboard, and show token: This will show the below code with a secret & token
# - copy this and paste it here:

rsconnect::setAccountInfo(name='mariaapps', token='E5890005C942BE2CF16E822548501223', secret='A2w/K7q9D48NDBq8S+TJYLv49Y5ZuvOLMQY9qyLu')
library(rsconnect)
