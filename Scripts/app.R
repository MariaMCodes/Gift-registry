...
ui <- fluidPage(
  fluidRow(
    ...
    br(),
    fluidRow(
      column(width = 4, img(src = "Header.png", height="150", width="220"), align = "center", style = "background-color:white;padding:18px;border-radius:2px"), 
    column(width = 8, p(strong("Description:"), "Ami de Coeur patch jumper", br(), strong("Colour:"), "Black", br(), strong("Size:"), "XS", br(), strong("Price:"), "$389", br(), 
             ...
             target = "blank", style = "color:black"), style = "background-color:#f8c8c8;padding:38px;border-radius:2px")),
  )
)
